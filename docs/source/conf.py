...
# kedro_code_upload documentation build
...
from kedro_code_upload import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_code_upload"
author = "Kedro"
...
htmlhelp_basename = "kedro_code_uploaddoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_code_upload.tex",
        "kedro_code_upload Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_code_upload",
        "Project kedro_code_upload codebase.",
        "Data-Science",
    )
]
